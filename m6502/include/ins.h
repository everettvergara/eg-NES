...
namespace eg::m6502
{
	...
	constexpr byte DEC_ZP = 0xC6;
	constexpr byte DEC_ZPX = 0xD6;
	constexpr byte DEC_ABS = 0xCE;
	constexpr byte DEC_ABSX = 0xDE;
